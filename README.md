...
共通キー: 1〜5 フィルム強度（切／弱／既定／標準／強）、B BGM、M 消音、Tab 計器表示、Enter やり直し

### 1人で遊ぶ / デモとして眺める

**C キー**を押すと 2P がコンピュータ操縦になります。押すたびに
切 → 弱 → 普通 → 強 → 切 と切り替わります。**V キー**は 1P 側の同じ切り替えで、
両方を CPU にすればデモとして眺められます。
